...
class ScraperInput(BaseModel):
    ...
    # Wellfound (Apify orgupdate API) — see README
    wellfound_company_name: str | None = None
    wellfound_pages_to_fetch: int | None = None
    wellfound_date_posted: str | None = None  # all, today, 3days, week, month
    wellfound_country_name: str | None = None  # e.g. usa, uk, india; overrides country_indeed mapping
    wellfound_api_url: str | None = None  # override default orgupdate endpoint
