...
def add_params(scraper_input) -> dict[str, str | int]:
    ...
    if location:
        ...
        # ZipRecruiter often returns empty results for broad country-only locations.
        # For remote searches, omitting location is more reliable.
        if scraper_input.is_remote and location_norm in broad_country_locations:
            location = None
